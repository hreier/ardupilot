...
ModeCtrlSprayFlow::ModeCtrlSprayFlow(void):
    _pid_press_right(SO_FLOW_RATE_RP_P, SO_FLOW_RATE_RP_I, SO_FLOW_RATE_RP_D, SO_FLOW_RATE_RP_FF, SO_FLOW_RATE_RP_IMAX, SO_FLOW_RATE_RP_FILT_T_HZ, SO_FLOW_RATE_RP_FILT_E_HZ, SO_FLOW_RATE_RP_FILT_D_HZ),
    _pid_press_left(SO_FLOW_RATE_RP_P, SO_FLOW_RATE_RP_I, SO_FLOW_RATE_RP_D, SO_FLOW_RATE_RP_FF, SO_FLOW_RATE_RP_IMAX, SO_FLOW_RATE_RP_FILT_T_HZ, SO_FLOW_RATE_RP_FILT_E_HZ, SO_FLOW_RATE_RP_FILT_D_HZ)
{
